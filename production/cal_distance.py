...
def cal_Distance_TransitTime(route, df): #--> distance and transit time
    ...
    for idx, p1 in enumerate(route):
        ...
        transit_time_dict[p1] = transit_time_list
        distance_dict[p1] = distance_list
    
    
    return distance_dict, transit_time_dict



#### =======> no used
def cal_Distance_TransitTime_list(route, df): #--> distance and transit time
    distance_list = []
    transit_time_list = []
